...
public class PlatillosDAO {
    ...
    public void insPlatillo() {
        try {
            String query = "Insert into tbl_platillos(nombre_platillo,precio,id_tipo) values ('"+nombre_platillo+"', "+precio
                    +","+id_tipo+")";
    ...
    public ObservableList<PlatillosDAO> getAllPlatillo() {
        ...
        try {
            PlatillosDAO objP;
            String query = "select * from tbl_platillos order by nombre_platillo DESC";
            Statement stmt = Conexion.con.createStatement();
